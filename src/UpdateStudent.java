...
public class UpdateStudent extends javax.swing.JFrame {
    ...
    public UpdateStudent(int id) {
        ...
        try {
            ...
            loadStudentData(); // نعرض البيانات في الفورم
        } catch (IOException e) {
            e.printStackTrace();
    ...
    for (Student s : list) {
        if (s.getStudentID() == studentId) { // استخدم studentId من الكونستركتور
         ...
         try {
            for (int i = 0; i < list.size(); i++) {
                ...
                if (s.getStudentID() == studentId) {
                    ...
                    s.setGpa((float) Double.parseDouble(Gpa.getText().trim()));
                    break;
                }
            }
            admin.saveToFile(list);
            javax.swing.JOptionPane.showMessageDialog(this, "Student updated successfu");
